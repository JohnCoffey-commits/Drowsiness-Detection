  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900 sm:p-5">
      ...
      {rows.length > 0 ? (
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row.sessionId}>
                  ...
                  <td className="border-b border-slate-100 py-3 pr-4 font-bold text-slate-900 dark:border-slate-800/70 dark:text-white">
                    {row.eventCount}
                  </td>
                  <td className="border-b border-slate-100 py-3 pr-4 font-bold text-red-600 dark:border-slate-800/70 dark:text-red-300">
                    {row.highPriorityCount}
                  </td>
                  <td className="border-b border-slate-100 py-3 pr-4 font-bold text-amber-600 dark:border-slate-800/70 dark:text-amber-300">
        ...
        <div className="flex min-h-[220px] items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-50 text-center text-sm font-medium text-slate-500 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-400">
